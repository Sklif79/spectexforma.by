	...
	<div  class="right_info">
		<div class="info_item">
			...
			<?if($isArticle || $arResult["BRAND_ITEM"] || $arParams["SHOW_RATING"] == "Y" || strlen($arResult["PREVIEW_TEXT"])){?>
				<div class="top_info">
					...
					<span class="value-art" itemprop="value">K13786A5</span>
        ...
        <div class="attention">
            <div class="attention--inner">
                <img src="/upload/product-images/sign-pr.png" alt="">
                <p>Работаем только с юридическими лицами </br>и индивидуальными предпринимателями</p>
            </div>
        </div>
		</div>
	</div>
